...
func NewRootCmd(version starboard.VersionInfo, args []string, outWriter io.Writer, errWriter io.Writer) *cobra.Command {
...
func Run(version starboard.VersionInfo, args []string, outWriter io.Writer, errWriter io.Writer) error {
